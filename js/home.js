        ...
        function runAnimations() {
            ...
            if (typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') {
                ...
                document.querySelectorAll('.anim-fade-in, .stat-item, .project-card, .service-card, .tech-logo').forEach(item => {
            ...
            tl.to(preloaderCircle, { scale: 1, duration: 0.5, ease: 'power2.out' })
              ...
              .to(preloaderBg, { opacity: 0, duration: 1, onComplete: () => preloaderBg.style.display = 'none' }, "-=1.5")
              .to(preloaderCircle, { opacity: 0, duration: 1, onComplete: () => {
                  preloaderCircle.style.display = 'none';
                  mainContent.style.visibility = 'visible';
              }}, "-=1")
              /* --- হিরো সেকশন অ্যানিমেশন (Navbar ফিক্স) --- */
              .to(header, { opacity: 1, duration: 1 }, "-=0.5")
              .to('.hero .anim-line-inner', { y: 0, duration: 1, stagger: 0.15, ease: 'power3.out' })
            ...
            gsap.utils.toArray('.anim-line-inner').forEach(line => {
                gsap.from(line, {
                    y: '110%', duration: 1, ease: 'power3.out', stagger: 0.1,
                    scrollTrigger: { 
            ...
            gsap.utils.toArray('.stat-item').forEach(item => {
                ...
                gsap.to(counter, { // .from() er bodole .to()
        ...
        function initializeProductHover() {
            ...
            productItems.forEach((item, index) => {
                ...
                const targetImage = document.querySelector(`.product-image-preview img[data-id="${targetImageId}"]`);
